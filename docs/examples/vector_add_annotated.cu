#pragma kernel_tuner tune(items_per_block=32, 64, 128, 256, 512, 1024)
#pragma kernel_tuner tune(items_per_thread=1, 2, 4, 8)
#pragma kernel_tuner set(items_per_block=items_per_block * items_per_thread)
#pragma kernel_tuner problem_size(n)
#pragma kernel_tuner block_size(items_per_block)
#pragma kernel_tuner grid_divisor(items_per_thread)
